...
CPersonEdit::_initMain() {
    ...
    // maps ui controls into DB fields
    {
        ...
        // DB controls to QMap
        {
            ...
            _m_hsDbControls.insert(CONFIG_DB_F_PHONES_PHONEHOME,       m_Ui.cboPhoneHome->lineEdit());
            _m_hsDbControls.insert(CONFIG_DB_F_PHONES_PHONEJOB,        m_Ui.cboPhoneJob->lineEdit());
            _m_hsDbControls.insert(CONFIG_DB_F_PHONES_PHONEADDITIONAL, m_Ui.tedtPhoneAdditional);
